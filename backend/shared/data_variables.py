...
DATA_VARIABLES: List[DataVariable] = [
    ...
    DataVariable(
        "Oil Cut",
        DataCategory.COMPOSITION,
        "%",
        5000,
        0,
        100,
        "Oil percentage in liquid",
        "separator",
    ),
    DataVariable(
        "Water Cut",
    ...
    DataVariable(
        "Power Factor", DataCategory.ELECTRICAL, "", 1000, 0, 1, "Power factor", "motor"
    ),
    DataVariable(
        "Active Power",
        DataCategory.ELECTRICAL,
